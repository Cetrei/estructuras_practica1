...
![C](https://img.shields.io/badge/C-implementación-A8B9CC?logo=c&logoColor=blue)
![Docs: Doxygen](https://img.shields.io/badge/docs-doxygen-2C4AA8?logo=doxygen&logoColor=white)
![Build: Make](https://img.shields.io/badge/build-make-427819?logo=gnu&logoColor=orange)
...
| Parte 3: Nota menor, nota mayor y promedio                           | [`src/Registros.c`](./src/Registros.c)     |
| Parte 3: Búsqueda secuencial del estudiante por carnet               | [`src/Registros.c`](./src/Registros.c)     |
| Parte 4:  Reporte con el formato del enunciado                       | [`src/Reporte.c`](./src/Reporte.c)         |
